      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.3] mb-8 drop-shadow-md max-w-4xl mx-auto"
            >
              Solusi Pengadaan <span className="text-primary-400">Barang Elektronik</span> & IT Terpercaya
            </motion.h1>
